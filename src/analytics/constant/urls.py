...
all_report_urls = {
    "revenue": ["revenue"],
    "analysis.revenue": ["guests-checks", "avg-check", "revenue.department", "revenue.store", "revenue.dish_group", "revenue.time", "revenue.price_segments", "revenue.date_of_week", "revenue.waiter", "check-depth"],
